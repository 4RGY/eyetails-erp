...
<div class="admin-card">
    <div class="admin-card-body">
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-row">
                <div class="form-group full-width"><label for="image">Ganti Gambar Produk</label><input type="file"
                        name="image" id="image" class="form-control">@if($product->image)<img
                        src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}"
                        style="max-width: 150px; margin-top: 10px; border-radius: 6px;">@endif</div>
            </div>
