...
<header class="admin-content-header">
    ...
    <p>Isi detail di bawah untuk menambahkan opsi pengiriman baru.</p>
</header>
...
<div class="admin-card">
    <div class="admin-card-body">
        ...
        <form action="{{ route('admin.shipping.store') }}" method="POST" class="admin-form modern-form">
            @csrf
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group full-width">
                    ...
                    <textarea name="description" id="description" rows="3" class="form-control"
                        placeholder="Contoh: Estimasi pengiriman 2-3 hari kerja">{{ old('description') }}</textarea>
                </div>
            </div>
...
@push('styles')
<style>
    /* Menggunakan style yang sama dengan form lain untuk konsistensi */
